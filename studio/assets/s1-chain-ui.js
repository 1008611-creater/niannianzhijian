(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      '#s1-chain-canvas .s1-node[data-champion-node]{width:322px;min-height:0;padding:0;overflow:hidden;border-color:rgba(58,55,49,.32);border-top:0;border-radius:8px;background:#fffdf9;box-shadow:0 12px 28px rgba(25,24,21,.24)}#s1-chain-canvas .s1-node[data-champion-node]::before{content:"";display:block;height:4px;background:#426f83}#s1-chain-canvas .s1-node[data-champion-node][data-champion-kind="assets"]::before{background:#85623d}#s1-chain-canvas .s1-node[data-champion-node][data-champion-kind="shotlist"]::before{background:#3e7771}#s1-chain-canvas .s1-node[data-champion-node][data-champion-kind="delivery"]::before{background:#884f47}#s1-chain-canvas .s1-node[data-champion-node] [data-s1-delete]{top:12px;right:12px;border-color:rgba(58,55,49,.16);background:#fffdf9;color:#685b50}#s1-chain-canvas .s1-champion-topline{display:flex;align-items:center;gap:8px;padding:13px 44px 0 14px;color:#74695e;font-size:10px;line-height:1.2}#s1-chain-canvas .s1-champion-role{font-weight:750;letter-spacing:.08em;color:#426f83}#s1-chain-canvas .s1-node[data-champion-node][data-champion-kind="assets"] .s1-champion-role{color:#85623d}#s1-chain-canvas .s1-node[data-champion-node][data-champion-kind="shotlist"] .s1-champion-role{color:#3e7771}#s1-chain-canvas .s1-node[data-champion-node][data-champion-kind="delivery"] .s1-champion-role{color:#884f47}#s1-chain-canvas .s1-champion-skill{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8a8077}#s1-chain-canvas .s1-champion-status{margin-left:auto;padding:3px 6px;border:1px solid rgba(58,55,49,.14);border-radius:4px;background:#f4f0ea;color:#665d55;font-size:10px;font-weight:700;white-space:nowrap}#s1-chain-canvas .s1-node[data-champion-node][data-status="ready"] .s1-champion-status{border-color:#8eb09b;background:#edf6ee;color:#376745}#s1-chain-canvas .s1-node[data-champion-node][data-status="blocked"] .s1-champion-status{border-color:#d3b796;background:#f8efe5;color:#785330}#s1-chain-canvas .s1-node[data-champion-node] h3{margin:6px 14px 2px;color:#292725;font-size:17px;line-height:1.25;letter-spacing:0}#s1-chain-canvas .s1-node[data-champion-node] .s1-champion-note{margin:0 14px 13px;color:#70675f;font-size:12px;line-height:1.5}#s1-chain-canvas .s1-champion-io{display:grid;grid-template-columns:1fr 1fr;gap:0;margin:0;border-top:1px solid #e8e0d8;border-bottom:1px solid #e8e0d8;background:#faf7f2}#s1-chain-canvas .s1-champion-io .s1-port-group{min-width:0;padding:10px 12px;color:#756b62;font-size:10px}#s1-chain-canvas .s1-champion-io .s1-port-group+ .s1-port-group{border-left:1px solid #e8e0d8}#s1-chain-canvas .s1-champion-io .s1-port-group small{font-size:10px;font-weight:750;letter-spacing:.05em;color:#8a7e73}#s1-chain-canvas .s1-node[data-champion-node] .s1-port-handle{overflow:hidden;padding:6px 7px;border-radius:4px;background:#fffdf9;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:10px;line-height:1.2;text-overflow:ellipsis;white-space:nowrap}#s1-chain-canvas .s1-node[data-champion-node] .s1-input-port{border-color:#9ab7c1}#s1-chain-canvas .s1-node[data-champion-node] .s1-output-port{border-color:#c8a982}#s1-chain-canvas .s1-champion-editor{display:grid;gap:6px;margin:13px 14px 0;color:#5e554d;font-size:11px;font-weight:700}#s1-chain-canvas .s1-champion-editor textarea{box-sizing:border-box;width:100%;min-height:66px;padding:8px;border:1px solid #d7ccc1;border-radius:6px;background:#fff;color:#2a2724;font:12px/1.45 Inter,system-ui,sans-serif;resize:vertical}#s1-chain-canvas .s1-champion-editor textarea:focus{outline:2px solid rgba(66,111,131,.34);outline-offset:1px;border-color:#426f83}#s1-chain-canvas .s1-champion-readiness{margin:10px 14px 0;padding:8px 9px;border-left:3px solid #cbb9a4;background:#f5f0e9;color:#665d55;font-size:11px;line-height:1.4}#s1-chain-canvas .s1-champion-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin:10px 14px 0}#s1-chain-canvas .s1-champion-actions button{min-height:32px;padding:7px 8px;border:1px solid transparent;border-radius:6px;font-size:11px}#s1-chain-canvas .s1-champion-actions [data-champion-save],#s1-chain-canvas .s1-champion-actions [data-champion-check]{background:#f1e9df;color:#4e4339}#s1-chain-canvas .s1-champion-actions [data-champion-check]{border-color:#d7c8b8;background:#fffdf9}#s1-chain-canvas .s1-champion-actions [data-champion-run]{grid-column:1 / -1;background:#2f4f5c;color:#fff}#s1-chain-canvas .s1-champion-contract{margin:10px 14px 14px;padding-top:9px;border-top:1px solid #eee7df;color:#81776d;font-size:10px;line-height:1.45}#s1-chain-canvas .s1-node[data-champion-node].s1-selected{outline-color:#426f83;box-shadow:0 0 0 4px rgba(66,111,131,.2),0 12px 28px rgba(25,24,21,.28)}@media (max-width:600px){#s1-chain-canvas .s1-node[data-champion-node]{width:304px}}',
