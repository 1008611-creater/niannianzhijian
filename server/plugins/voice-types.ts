...
export type VoiceProvider = 'elevenlabs' | 'doubao' | 'minimax' | 'mimo' | 'openai-tts' | 'inworld' | 'fishaudio' | 'speechify';
...
export interface VoiceOptions {
  ...
  mimoApiKey: string;
  mimoModel: string;
  /** OpenAI-compatible /audio/speech endpoint (base URL normally ends in /v1). */
