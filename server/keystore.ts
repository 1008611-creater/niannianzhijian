...
export const KEY_NAMES = [
  ...
  "LLM_TOKENRHYTHM_API_KEY",
  "LLM_TOKENRHYTHM_BASE_URL",
  "LLM_TOKENRHYTHM_MODEL",
  "LLM_OLLAMA_API_KEY",
  "LLM_OLLAMA_BASE_URL",
  "LLM_OLLAMA_MODEL",
...
export const NON_SECRET_NAMES: ReadonlySet<string> = new Set([
  ...
  "TESSERACT_OCR_PATH", // Local executable path; not a credential
  "TESSERACT_TESSDATA_DIR", // Optional language-data directory; not a credential
...
export function computeCaps(): Caps {
  ...
  return {
    ...
    voice:
      ...
      has("MINIMAX_API_KEY") ||
      has("MIMO_TTS_API_KEY") ||
      has("OPENAI_TTS_API_KEY") ||
