...
const MODEL_ROUTING_NAMES = [
  'LLM_PROVIDER', 'LLM_AGENT_FALLBACK_ORDER', 'LLM_MODEL', 'CODEX_MODEL', 'CODEX_REASONING_EFFORT', 'LLM_OPENAI_API_MODE',
  ...
  'MIMO_TTS_MODEL', 'MIMO_ASR_MODEL', 'OPENAI_TTS_MODEL', 'OPENAI_ASR_MODEL', 'OPENAI_VISION_MODEL',
  'WAVESPEED_IMAGE_MODEL', 'BYTEPLUS_IMAGE_MODEL', 'BYTEPLUS_VIDEO_MODEL',
  'INWORLD_TTS_MODEL', 'FISHAUDIO_TTS_MODEL', 'SPEECHIFY_TTS_MODEL',
  'PREFERRED_IMAGE_VENDOR', 'PREFERRED_VOICE_VENDOR', 'PREFERRED_VIDEO_VENDOR', 'PREFERRED_MUSIC_VENDOR', 'PREFERRED_TRANSCRIPTION_VENDOR',
  ...
  'TESSERACT_OCR_PATH', 'TESSERACT_TESSDATA_DIR',
] as const;
