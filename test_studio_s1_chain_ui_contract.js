...
assert.match(source, /querySelectorAll\('\[data-s1-add-skill\]'\)\.forEach/);
assert.match(source, /data-champion-node.*card\.remove/);
assert.doesNotMatch(source, /function createChampionNode/);
assert.doesNotMatch(source, /function installSkillToolbar/);
assert.doesNotMatch(source, /function runChampionNode/);
...
assert.match(source, /data-s3-aspect/);
assert.match(source, /data-s3-resolution/);
assert.match(source, /model:'minimax-h3'/);
assert.match(source, /resolution:h3Resolution.value/);
assert.match(source, /h3Resolution.value = h3.data/);
...
assert.doesNotMatch(source, /data-champion-input/);
assert.doesNotMatch(source, /data-champion-save/);
assert.doesNotMatch(source, /生成交付包/);
...
assert.doesNotMatch(source, /生成画布工具栏/);
assert.match(source, /retireLegacyCards/);
assert.match(source, /card\.hidden = true/);
assert.doesNotMatch(source, /key:'s1-chain'/);
assert.doesNotMatch(source, /打开原片转绘链/);
