...
assert.match(html, /admin-model-visibility-r1\.js\?v=20260818-storyboard-group-contract-r8/);
assert.match(rootHtml, /admin-model-visibility-r1\.js\?v=20260818-storyboard-group-contract-r8/);
assert.ok(source.includes("'/api/auth/session'"));
assert.ok(source.includes('模型接入|接入模型|添加模型|中转站|供应商配置'));
