...
本地可用 Image2 渠道仅 `yunfei-1k`（1024×1024 方图），不符合权威目标图
1440×900 / 390×844 尺寸门；Krill/meinianda 渠道无本地可用密钥。按计划
回退为“真实截图 + 标注”方案：目标图即当前真实实现页面，结构、品牌、
文案与可见控件保持原样，不虚构能力。
...
| 01-project-hub-desktop.png | `https://ai.cauai.fun/#projects` | 1440×900 | 统计 5/0/5/0；列表 5 个转绘项目（示例名）；搜索与状态筛选 | 已与统计一致；移动端长列表状态标签不换行 |
