...
- 体验关：为 PR 当前精确提交提供独立 HTTPS 预览，公开健康回读必须证明预览 SHA 与 PR HEAD 完全一致；主动给出可直接打开的线上网址、改动和风险，并附最短验收路径与逐项验收清单，由产品负责人在电脑和手机走核心路径。只给 GitHub PR 链接、截图或本地地址不算体验关交付。
...
- 每次需要用户验收时，先部署当前候选到可访问的 HTTPS 地址，再在回复中给出网址、候选提交 SHA、改动摘要、风险/回滚点和电脑/手机各一条核心路径。
