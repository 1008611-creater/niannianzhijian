...
- Providers: doubao (Chinese-optimized), mimo (Xiaomi MiMo V2.5, preset voices such as 冰糖/茉莉/苏打/白桦), openai-tts (any OpenAI-compatible /audio/speech endpoint), elevenlabs (English/multilingual), minimax (when configured). Never mix voice catalogs across providers.
