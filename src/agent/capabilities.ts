...
const CAP_PROVIDERS: Partial<Record<CapabilityKey, ProviderRow[]>> = {
  ...
  voice: [
    ...
    { label: 'MiMo TTS', arg: 'mimo', argKey: 'provider', need: [['MIMO_TTS_API_KEY']] },
    { label: 'OpenAI 兼容 TTS', arg: 'openai-tts', argKey: 'provider', need: [['OPENAI_TTS_API_KEY']] },
  ...
  transcription: [
    ...
    { label: 'OpenAI 兼容 ASR', arg: 'openai-asr', argKey: 'provider', need: [['OPENAI_ASR_API_KEY']] },
  ],
  stock: [
