...
export type VendorId =
  | 'llm' | 'anthropic' | 'openai' | 'gemini' | 'kimi' | 'qwen' | 'glm' | 'deepseek' | 'mistral' | 'openrouter' | 'tokenrhythm'
  | 'ollama' | 'lmstudio' | 'xiaomi' | 'mimo' | 'minimax' | 'hailuo' | 'elevenlabs' | 'doubao'
...
const SVG_ICONS: Partial<Record<VendorId, SvgIcon>> = {
  ...
  mimo: { svg: xiaomimimoSvg, tint: '#FF6900' },        // MiMo TTS/ASR shares Xiaomi's official mark
...
const MONOGRAMS: Partial<Record<VendorId, { bg: string; mono: string; fg?: string }>> = {
  ...
  tokenrhythm: { bg: '#1f2937', mono: 'TR', fg: '#f7f7f8' },
};
