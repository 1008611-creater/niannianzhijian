...
export interface CaptionsData {
  ...
  /**
   * Provenance written by prepare_rough_cut_captions.  It makes the generated
   * caption track auditable without changing how the renderer resolves words.
   */
  roughCutVoiceover?: {
    version: 1;
    kind: 'rough-cut-voiceover';
    voiceItemIds: string[];
