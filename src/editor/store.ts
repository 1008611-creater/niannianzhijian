...
export interface EditorCommands {
  ...
  /** Edit library metadata, code defaults, exact ingest clocks, or source-bound intelligence. */
  editMediaAsset: (id: string, patch: Partial<Pick<MediaAsset, 'name' | 'code' | 'props' | 'favorite' | 'sourceTimecode' | 'captureClock' | 'intelligence'>>) => void;
